      ...
      <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition">
         <h2 class="text-xl font-semibold mb-2 text-gray-800 dark:text-gray-100">Start 2-Player Match</h2>
            <div class="flex gap-2">
              <button id="playDuoBtn" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md">Online</button>
              <button id="playDuoLocalBtn" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md">Local</button>
            </div>
        </div>
        ...
        <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition">
            ...
            <div class="flex gap-2">
              <button id="playQuadBtn" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md">Online</button>
              <button id="playQuadLocalBtn" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md">Local</button>
            </div>
        </div>
